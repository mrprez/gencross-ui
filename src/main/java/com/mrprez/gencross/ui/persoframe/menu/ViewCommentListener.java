...
public class ViewCommentListener implements ActionListener {
	private PropertyTree propertyTree;
	
	
	public ViewCommentListener(PropertyTree propertyTree) {
		super();
	...
	public void actionPerformed(ActionEvent arg0) {
		...
		if(selectedNode.getUserObject() instanceof Property){
			...
			GenCrossUI.getCurrentPersoFrame().getViewCommentFrame().displayComment((Property)selectedNode.getUserObject());
		}
	}
